package com.example.mauchatbot
...
import com.example.mauchatbot.api.*
import com.example.mauchatbot.api.model.ChatCompletionRequest
import com.example.mauchatbot.api.model.ChatCompletionResponse
import com.example.mauchatbot.api.model.Message
import com.example.mauchatbot.api.model.TranscriptResponse
import com.example.mauchatbot.popup.LoadingScreen
    ...
    private fun sendTextPrompt(
        ...
        OpenAiAPI(tokenApi.text.toString()).chatCompletion(request).enqueue(object : Callback<ChatCompletionResponse> {
            ...
            override fun onResponse(
                ...
                val chatGpt = "<b>MauChatBot:</b> ${response.body()?.choices?.get(0)?.message?.content}<br>"
